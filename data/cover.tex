...
Saliency detection is widely useful for many computer vision applications, such as image segmentation, object recognition, image retargeting, video compression, etc. Being simple, fast, effective, and independent of categories, or other forms of prior knowledge, saliency detection in the frequency domain (spectral saliency) attracts more study  since it was presented. This paper introduces the detailed procedure of the algorithm in frequency domain and overviews the domestic and overseas models. The analysis indicates that many computational methods have uniform salient object detection and unsatisfactory saliency details detection. To address these issues, a novel saliency detection model---salient object detection via automatic adaptive amplitude spectrum analysis is proposed in this paper. 
